...
`focal()` can be used to replace the value of a focal cell by some function of its neighbours. Which neighbors and what function to use can be chosen as arguments. 
