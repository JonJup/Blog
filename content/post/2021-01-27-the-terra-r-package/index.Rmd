...
Its also slower than it could be and doesn't support HDF5 files, which is a popular format for satellite data
complex.
...
Apply a function with the layers of a raster.
...
In many cases you have to switch between the two fundamental spatial data models raster and vector.
