...
Let's have a look at the summary of this model. First we get the call we used to construct the model. The second element is a matrix with the coefficients. beta0 us the species specific intercept, theta1 and theta2 are the species-specific coefficient of the latent variables ($\theta_{0j},\theta_{j1},\theta_{j2} $ in @Hui2016)
