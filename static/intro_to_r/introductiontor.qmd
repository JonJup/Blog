...
-   Schreibe einen If-clause der testet ob ein Objekt eine Matrix ist.

-   Schreibe einen If-clause der die Länge eines Vektors evaluiert. Falls die Länge größer ist als 5 wird schreibt der If-clause "lang". Falls die länge kürzer als oder gleich fünf ist fügt der If-clause so viele elemente hinzu wie notwendig damit die Länge größer fünf ist.
...
-   Schreiben Sie einen for-Loop, die die Zahlen 1 bis 7 durchläuft und den Kubus jeder Zahl mit `print()` ausgibt.

-   Schreibe einen for-loop der von 10 zu 1 runterzählt. In jeder Iteration wird eine Zahl aus einer Normalverteilung simuliert. Ist die Zahl größer 0 wird sie von i abgezogen, ist sie keliner 0 wird sie addiert. das Ergenbnis wird zur Konsole gedruckt
...
## Aufgaben Eigene Funktion schreiben
